...
#ifdef XP_MACOSX
  // enable the cmd_dontsave command if applicable
  if (gCommonDialogParam.GetInt(7) >= 0)
    document.getElementById("cmd_dontsave").removeAttribute("disabled");
#endif
...
function commonDialogOnDontSave()
{
  gCommonDialogParam.SetInt(0, gCommonDialogParam.GetInt(7));
  window.close();
}
