...
pref("celtx.scripteditor.daynights", "ZI,NOAPTE");
pref("celtx.scripteditor.shots","LARG:,PRINCIPAL:,MEDIU:,CLOSE UP:,PRIM PLAN:,CUTAWAY:,CUT-IN:,TWO-SHOT:,PESTE UMĂR:,POV:");
