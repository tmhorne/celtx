...
pref("celtx.scripteditor.daynights", "DAG,NACHT");
pref("celtx.scripteditor.shots","WIDE:,MASTER:,MEDIUM:,CLOSE UP:,EXTREME CLOSE UP:,CUTAWAY:,CUT-IN:,TWO-SHOT:,OVER DE SCHOUDER:,POV:");
