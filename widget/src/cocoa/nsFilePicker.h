...
public:
  ...
  void PopupSelected(NSPopUpButton* popup);
...
protected:
  ...
  NSArray  *GeneratePopupFilterArray(PRBool* outAllowsAny);
  ...
  NSSavePanel*           mPanel; // Weak ref
  NSArray*               mPopupFilterArray;
  CXPopupDelegate*       mPopupDelegate;
  PRBool                 mAllowOther;
};
